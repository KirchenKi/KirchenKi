  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-lg font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        accent:
          "bg-accent text-accent-foreground shadow-soft hover:shadow-elevated hover:scale-[1.02] active:scale-[0.98]",
        success:
          "bg-success text-success-foreground shadow-soft hover:shadow-elevated",
      },
      size: {
        default: "min-h-[48px] px-6 py-3",
        sm: "min-h-[40px] rounded-lg px-4 py-2 text-base",
        lg: "min-h-[56px] rounded-xl px-8 py-4 text-xl",
        xl: "min-h-[64px] rounded-2xl px-10 py-5 text-xl",
